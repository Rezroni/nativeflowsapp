...
export interface TextareaProps extends React.ComponentProps<"textarea"> {
  /**
   * Whether to animate the textarea on focus/blur
   * @default true
   */
  animated?: boolean
...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({
    ...
    // Base textarea without animations
    if (!animated) {
      return (
    ...
    return (
      <div className="w-full">
        <div className="relative">
          ...
          <textarea
            className={cn(
              "flex min-h-[80px] w-full rounded-md border bg-background px-3 text-base ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm relative z-0",
